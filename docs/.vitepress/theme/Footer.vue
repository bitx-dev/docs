    ...
    <div class="footer-container">
      ...
      <div class="footer-section">
        ...
        <div class="footer-social">
          <a href="https://github.com/bitxpay" target="_blank" rel="noopener" aria-label="GitHub">
          ...
          <a href="https://discord.gg/bitxpay" target="_blank" rel="noopener" aria-label="Discord">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="https://twitter.com/bitxpay" target="_blank" rel="noopener" aria-label="Twitter">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
...
.footer-title {
  ...
  margin: 0 0 1rem 0;
  background: linear-gradient(120deg, var(--bitx-accent-light), var(--bitx-gold-light));
